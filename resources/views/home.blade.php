...
@php
    ...
    $trustedIndustries = ['Healthcare', 'Government', 'Education', 'Manufacturing', 'NGOs', 'Agriculture', 'Finance', 'Logistics', 'Retail', 'Telecommunications'];
        ...
        <div class="grid gap-10 lg:grid-cols-12 lg:items-start">
            ...
            <div class="lg:col-span-7">
                <div class="grid grid-cols-2 gap-3 sm:grid-cols-3 xl:grid-cols-5">
                    @foreach ($trustedIndustries as $industry)
                        <div class="rounded-2xl border border-slate-200 bg-slate-50 px-4 py-4 text-center text-sm font-semibold text-slate-700 shadow-sm transition hover:-translate-y-0.5 hover:border-primary/20 hover:bg-white">
                            {{ $industry }}
                        </div>
                    @endforeach
                </div>
